 ...
 * Useful when the current token is expired (platform issues 10-minute TTL
 * session tokens — the AppBridgeProvider proactively refreshes every 9 min
 * and this function is also called by the api.js 401 retry path).
